  ...
  const faqs = [
    {
      question: language === 'fr' 
        ? "Combien coûte une rénovation résidentielle typique?"
    ...
    {
      question: language === 'fr' 
        ? "Offrez-vous des devis gratuits pour la rénovation de cuisine?"
        : "Do you provide free estimates for kitchen renovation?",
      answer: language === 'fr' 
    ...
    {
      question: language === 'fr' 
        ? "Êtes-vous un entrepreneur RBQ licencié en rénovation?"
        : "Are you a licensed RBQ renovation contractor?",
      answer: language === 'fr' 
    ...
    {
      question: language === 'fr' 
        ? "Gérez-vous les permis et inspections pour les rénovations?"
        : "Do you handle permits and inspections for renovations?",
      answer: language === 'fr' 
    ...
    {
      question: language === 'fr' 
        ? "Combien de temps prend généralement une rénovation de salle de bain?"
    ...
    {
      question: language === 'fr' 
        ? "Offrez-vous des services de design pour les rénovations commerciales?"
        : "Do you offer design services for commercial renovations?",
      answer: language === 'fr' 
    ...
    {
      question: language === 'fr' 
        ? "Quelles zones servez-vous pour la rénovation résidentielle?"
        : "What areas do you serve for home renovation?",
      answer: language === 'fr' 
        ? "Nous servons fièrement les régions environnantes, y compris Laval, l'Ouest-de-l'Île, la Rive-Sud et les Laurentides."
        : "We proudly serve surrounding areas, including Laval, the West Island, the South Shore, and the Laurentians."
    },
    {
      question: language === 'fr' 
        ? "Offrez-vous une garantie pour les services d'entrepreneur RBQ en rénovation?"
        : "Do you offer warranty for RBQ renovation contractor services?",
      answer: language === 'fr' 
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <h2 className="text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-6">
            {language === 'fr' 
              ? <>Rénovation <span className="text-prime-orange">FAQ</span></>
              : <>Renovation <span className="text-prime-orange">FAQ</span></>
            }
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            {language === 'fr' 
              ? "Questions courantes sur la rénovation résidentielle, la rénovation de cuisine, et nos services d'entrepreneur RBQ en rénovation"
              : "Common questions about home renovation, kitchen renovation, and our RBQ renovation contractor services"
            }
          </p>
        </div>
