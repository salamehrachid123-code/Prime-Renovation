...
const RoofingRepairReplacementMontreal = ({ language }) => {
  useEffect(() => {
      ...
      <main className="container mx-auto px-6 py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
            Protect your Montreal home with expert roofing repair and replacement services. From emergency repairs 
            to complete roof replacements, our skilled team ensures your roof withstands Montreal's challenging 
            weather conditions while maintaining your home's value and safety.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold text-prime-orange mb-4">Montreal Weather Expertise</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Our experienced roofing team understands Montreal's unique climate challenges, from heavy snow loads 
                to ice dams and temperature fluctuations. We design and install roofing systems that perform 
                optimally in local weather conditions.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                ...
                every roofing project meets local building codes and safety standards. Your investment 
                is protected with comprehensive insurance coverage.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-semibold text-prime-orange mb-4">Emergency Repair Services</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Montreal's weather can cause sudden roof damage. We provide emergency roofing repair services 
                to protect your home from water damage and ensure your family's safety during severe weather.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-semibold text-prime-orange mb-4">Quality Materials & Workmanship</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                We use only premium roofing materials from trusted manufacturers and employ skilled craftsmen 
                who deliver exceptional results that stand up to Montreal's challenging climate.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">
            {language === 'fr' ? 'Ce qui est Inclus' : 'What\'s Included'} in Our {language === 'fr' ? 'Réparation & Remplacement de Toiture Montréal' : 'Roofing Repair & Replacement Montreal'} Services
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-prime-orange mb-3">Roof Repairs</h3>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-prime-orange mb-3">Complete Roof Replacement</h3>
              <ul className="text-gray-600 dark:text-gray-300 space-y-2">
                <li>• Asphalt shingle installation</li>
                <li>• Metal roofing systems</li>
                <li>• Flat roof replacement</li>
                <li>• Underlayment and ventilation</li>
              </ul>
            </div>
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-prime-orange mb-3">Maintenance & Inspection</h3>
              <ul className="text-gray-600 dark:text-gray-300 space-y-2">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">
            Our Roofing Repair & Replacement Process
          </h2>
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Thorough roof inspection to assess damage, identify issues, and determine the best 
                repair or replacement solution for your Montreal home.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-prime-orange text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Detailed project planning including material selection, timeline, and permit applications 
                to ensure a smooth roofing project.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-prime-orange text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Expert roofing installation by our skilled Montreal team with daily progress updates 
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Complete cleanup and final inspection to ensure your Montreal roofing project 
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Prime Renovations provides expert roofing repair and replacement services throughout the Greater Montreal area. 
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                From heritage homes in Old Montreal to modern condos downtown, we specialize in roofing 
                solutions that respect Montreal's architectural character while providing superior protection.
              </p>
            </div>
            <div>
        ...
        <section className="bg-gradient-to-r from-prime-orange to-orange-600 rounded-2xl p-8 text-center text-white mb-12">
          ...
          <p className="text-xl mb-6 opacity-90">
            Get your free quote today and discover why Montreal homeowners trust Prime Renovations for their roofing needs.
          </p>
          <Link 
            to="/" 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Montreal's trusted renovation company specializing in roofing repair and replacement, kitchen renovations, 
...
export default RoofingRepairReplacementMontreal;
