...
const CustomMillworkBuiltinsMontreal = ({ language }) => {
  useEffect(() => {
      ...
      <main className="container mx-auto px-6 py-12">
        ...
        <section className="mb-12">
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            {language === 'fr' ? 'Menuiserie sur Mesure & Encastrés Montréal' : 'Custom Millwork & Built-ins Montreal'}
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
            Transform your Montreal home with custom millwork and built-in solutions that maximize space and style. 
            From custom cabinetry to built-in shelving and entertainment centers, our skilled craftsmen create 
            beautiful, functional pieces that perfectly fit your Montreal home's unique character and needs.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold text-prime-orange mb-4">Expert Montreal Craftsmen</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Our skilled craftsmen understand Montreal's diverse architectural styles, from heritage homes 
                in Old Montreal to modern condos downtown. We create custom millwork that respects your home's 
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                ...
                every custom millwork project meets local building codes and safety standards. Your 
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                We use only high-quality hardwoods and materials from trusted suppliers, combined with traditional 
                woodworking techniques that ensure your custom pieces stand the test of time in Montreal's climate.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-semibold text-prime-orange mb-4">Custom Design Solutions</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Every Montreal home is unique, and our design team creates custom millwork solutions that 
                maximize your space while reflecting your personal style and functional needs.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">
            {language === 'fr' ? 'Ce qui est Inclus' : 'What\'s Included'} in Our {language === 'fr' ? 'Menuiserie sur Mesure & Encastrés Montréal' : 'Custom Millwork & Built-ins Montreal'} Services
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-prime-orange mb-3">Custom Cabinetry</h3>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-prime-orange mb-3">Built-in Features</h3>
              <ul className="text-gray-600 dark:text-gray-300 space-y-2">
                <li>• Entertainment centers</li>
                <li>• Bookshelves and libraries</li>
                <li>• Window seats</li>
                <li>• Murphy beds</li>
              </ul>
            </div>
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-prime-orange mb-3">Millwork Details</h3>
              <ul className="text-gray-600 dark:text-gray-300 space-y-2">
                <li>• Crown molding</li>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">
            Our Custom Millwork & Built-ins Process
          </h2>
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Free in-home consultation to assess your Montreal millwork needs, 
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Custom design and detailed planning for your Montreal millwork project, 
                including material selection and 3D visualization.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-prime-orange text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Crafting</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Expert crafting and installation by our skilled Montreal craftsmen 
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Complete finishing and final inspection to ensure your Montreal millwork 
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Prime Renovations provides expert custom millwork and built-in services throughout the Greater Montreal area. 
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                From heritage homes in Old Montreal to modern condos downtown, we specialize in custom millwork 
                that respects Montreal's architectural character while providing contemporary functionality.
              </p>
            </div>
            <div>
        ...
        <section className="bg-gradient-to-r from-prime-orange to-orange-600 rounded-2xl p-8 text-center text-white mb-12">
          <h2 className="text-3xl font-bold mb-4">Ready to Start Your Custom Millwork Project?</h2>
          <p className="text-xl mb-6 opacity-90">
            Get your free quote today and discover why Montreal homeowners trust Prime Renovations for their custom millwork needs.
          </p>
          <Link 
            to="/" 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Montreal's trusted renovation company specializing in custom millwork and built-ins, kitchen renovations, 
...
export default CustomMillworkBuiltinsMontreal;
