...
const BathroomRenovationMontreal = ({ language }) => {
  useEffect(() => {
      ...
      <main className="container mx-auto px-6 py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
            Create your personal spa retreat with our expert bathroom renovation Montreal services. 
            From modern master bathrooms to efficient powder rooms, we transform your Montreal bathroom 
            into a beautiful, functional space that enhances your daily routine and increases your home's value.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold text-prime-orange mb-4">Expert Montreal Bathroom Design</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Our Montreal bathroom renovation specialists understand the unique challenges of local homes, 
                from small condos to spacious family homes. We maximize every square foot to create 
                functional, beautiful bathrooms that work for your lifestyle.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-semibold text-prime-orange mb-4">RBQ Licensed & Insured</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                As licensed RBQ contractors serving Montreal, Laval, West Island, and South Shore, 
                we ensure every bathroom renovation meets local building codes and safety standards. 
                Your project is protected with comprehensive insurance coverage.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-semibold text-prime-orange mb-4">Premium Materials & Fixtures</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                We work with trusted suppliers throughout Montreal to source high-quality materials, 
                fixtures, and finishes that stand up to daily use while maintaining their beauty for years to come.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-semibold text-prime-orange mb-4">Waterproofing Expertise</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Montreal's climate requires expert waterproofing and moisture management. Our team 
                specializes in proper installation techniques to prevent water damage and ensure 
                your bathroom renovation lasts for decades.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">
            {language === 'fr' ? 'Ce qui est Inclus' : 'What\'s Included'} in Our {language === 'fr' ? 'Rénovation de Salle de Bain Montréal' : 'Bathroom Renovation Montreal'} Services
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-prime-orange mb-3">Design & Planning</h3>
              <ul className="text-gray-600 dark:text-gray-300 space-y-2">
                <li>• 3D bathroom design and layout planning</li>
                <li>• Fixture selection and placement</li>
                <li>• Lighting design for optimal functionality</li>
                <li>• Ventilation and moisture control planning</li>
              </ul>
            </div>
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              ...
              <ul className="text-gray-600 dark:text-gray-300 space-y-2">
                ...
                <li>• Mirror and lighting installation</li>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Free in-home consultation to assess your Montreal bathroom renovation needs, 
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Custom 3D design and detailed planning for your Montreal bathroom renovation, 
                including material selection and fixture placement.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-prime-orange text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Complete inspection and handover of your beautiful new Montreal bathroom 
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Prime Renovations provides expert bathroom renovation services throughout the Greater Montreal area. 
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                From heritage homes in Old Montreal to modern condos downtown, we specialize in bathroom 
                renovations that respect Montreal's architectural character while adding contemporary functionality.
              </p>
            </div>
            <div>
        ...
        <section className="bg-gradient-to-r from-prime-orange to-orange-600 rounded-2xl p-8 text-center text-white mb-12">
          <h2 className="text-3xl font-bold mb-4">Ready to Start Your Bathroom Renovation?</h2>
          <p className="text-xl mb-6 opacity-90">
            Get your free quote today and discover why Montreal homeowners trust Prime Renovations for their bathroom renovation projects.
          </p>
          <Link 
            to="/" 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Montreal's trusted renovation company specializing in bathroom renovations, kitchen renovations, 
...
export default BathroomRenovationMontreal;
